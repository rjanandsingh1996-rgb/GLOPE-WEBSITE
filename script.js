...
const translations = {
  hi: {
    ...
    storyEyebrow:'GLOPE की कहानी', storyTitle:'एक सरल विचार।<br><em>एक बड़ा उद्देश्य।</em>',
    storyP1:'किसान परिवार में बड़े होते हुए शहद रोज़मर्रा की ज़िंदगी का हिस्सा था। घर में ही शहद निकाला जाता था और उसके स्रोत को लेकर कोई रहस्य नहीं था।',
    storyP2:'उस माहौल से बाहर आने पर सवाल अलग था: रोज़मर्रा के कृषि उत्पाद परिवारों तक अधिक वास्तविक और पारदर्शी तरीके से कैसे पहुँचें?',
    timeline1Title:'निर्णय', timeline2Title:'GLOPE की शुरुआत', timeline3Title:'एक कठिन दौर', timeline4Title:'उबरना', timeline5Title:'खेत से परिवार तक',
    timeline1P:'Ashish Singh ने IPCC की तैयारी छोड़कर मधुमक्खियों, उत्पादन, गुणवत्ता और मिलावट को समझने के लिए अध्ययन शुरू किया।',
    timeline2P:'2019 में GLOPE की शुरुआत एक Honey Farm के रूप में हुई, एक सरल product-first विचार के साथ।',
    timeline3P:'COVID-19 महामारी के दौरान नए व्यवसाय को भारी नुकसान हुआ।',
    timeline4P:'2022 में व्यवसाय ने फिर से गति पकड़ी और इसका दीर्घकालिक उद्देश्य और स्पष्ट हुआ।',
    timeline5P:'आज genuine products, उचित pricing और किसानों के लिए बेहतर value इस यात्रा के केंद्र में हैं।',
    beliefEyebrow:'हमारी सोच', beliefTitle:'न कोई दिखावटी विज्ञापन।<br><em>न कोई अतिरिक्त दावा।</em>',
    ...
    peopleEyebrow:'GLOPE के पीछे', peopleTitle:'दो लोग।<br><em>एक सरल विचार।</em>',
    peopleIntro:'GLOPE एक family-led brand है। इसके पीछे के लोग काम में सीधे जुड़े रहते हैं।',
    founderName:'Ashish Singh',
    founderDesc:'GLOPE के Founder, जो Chartered Accountancy की पढ़ाई कर रहे हैं और किसान परिवार से मिली शहद की समझ को एक व्यवसाय में बदलने की यात्रा के पीछे हैं।',
