...
const translations = {
  hi: {
    ...
    whyEyebrow:'WHY GLOPE', whyTitle:'Rooted in values.<br><em>Built with care.</em>',
    whyIntro:'We are building GLOPE step by step, with a simple focus on the product, the people behind it and the families who bring it home.',
    why1Title:'Farm-rooted', why1P:'GLOPE began with a farmer-family connection and a close understanding of where our journey started.',
    why2Title:'Quality conscious', why2P:'We prefer to understand the product and its journey before making claims about it.',
    why3Title:'Honest approach', why3P:'No unnecessary promises. We want the product and the information around it to speak clearly.',
    why4Title:'Made for families', why4P:'We are building products with the same care and thoughtfulness we would want for our own homes.',
    detailsLabel:'PRODUCT DETAILS', detailsTitle:'Simple information.<br><em>No unnecessary noise.</em>',
    detailsIntro:'Clear product information, so you know what you are ordering before it reaches your home.',
    detailProduct:'Product', detailPacks:'Pack sizes', detailIngredients:'Ingredients', detailHoney:'Honey', detailOrigin:'Country of Origin', detailStorage:'Storage', detailStorageValue:'Store in a cool, dry place', detailFssai:'FSSAI License',
