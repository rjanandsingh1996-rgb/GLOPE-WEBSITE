...
const translations = {
  hi: {
    ...
    founderName:'Ashish Singh', founderLabel:'GLOPE की कहानी', founderRole:'GLOPE के Founder', founderPhotoLabel:'संस्थापक', founderLead:'किसान परिवार से लेकर उस उत्पाद के आसपास एक ब्रांड बनाने तक, जिसे वे बचपन से जानते थे।', founderTags:'Business · Brand · Entrepreneurship', brotherLabel:'02 • FAMILY & PRODUCT', brotherTags:'Chemistry · Teaching · Technology', instagramHandle:'Instagram · @glopeagro',
    founderDesc:'Ashish किसान परिवार में पले-बढ़े, जहाँ शहद उनके परिवार की रोज़मर्रा की ज़िंदगी का हिस्सा था। 2017 में उन्होंने IPCC की तैयारी से अलग होकर मधुमक्खियों, उत्पादन, गुणवत्ता और मिलावट को समझने का अध्ययन शुरू किया। यही सीख 2019 में Honey Farm के रूप में शुरू हुए GLOPE की नींव बनी।', founderQuote:'“इसकी शुरुआत एक सरल सवाल से हुई — क्या हम अपनी थाली में आने वाली चीज़ों पर भरोसा कर सकते हैं?”',
