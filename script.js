...
const translations = {
  hi: {
    ...
    trust3:'उत्पाद पर ध्यान<small>उत्पाद को प्राथमिकता</small>',
    ...
    detailsLabel:'उत्पाद की जानकारी', detailsTitle:'उत्पाद की जरूरी जानकारी।',
    ...
    gheeDesc:'जल्द उपलब्ध होगा। GLOPE Ghee तैयार होने पर हम इसकी जानकारी साझा करेंगे।',
    farmEyebrow:'जहाँ से शुरुआत हुई',
    farmTitle:'खेत के करीब।<br><em>उत्पाद के करीब।</em>',
    farmP1:'हमारी शहद यात्रा स्रोत के करीब से शुरू हुई — किसान परिवार से मिले अनुभव और उत्पाद की समझ के साथ।',
    farmP2:'आज भी वही जुड़ाव तय करता है कि हम परिवारों के लिए उत्पादों को कैसे देखते और प्रस्तुत करते हैं।',
    ...
    peopleEyebrow:'GLOPE के पीछे', peopleTitle:'GLOPE के<br><em>पीछे के लोग।</em>',
    peopleIntro:'GLOPE एक family-led brand है। इसके पीछे के लोग उत्पाद और काम — दोनों से सीधे जुड़े रहते हैं।',
    founderName:'Ashish Singh', founderLabel:'01 • FOUNDER', founderRole:'GLOPE के Founder', founderPhotoLabel:'संस्थापक', founderLead:'', founderTags:'Business · Brand · Entrepreneurship', brotherLabel:'02 • FAMILY & PRODUCT', brotherTags:'Chemistry · Teaching · Technology', instagramHandle:'Instagram · @glopeagro',
    founderDesc:'GLOPE के Founder Ashish किसान परिवार में पले-बढ़े। शहद से जुड़ाव के बाद उन्होंने मधुमक्खियों, उत्पादन, गुणवत्ता और मिलावट को समझने का अध्ययन किया और 2019 में GLOPE की शुरुआत Honey Farm के रूप में की।',
    ...
    contactDesc:'Product enquiries, availability या support के लिए सीधे हमसे बात करें।',
    footerTagline:'खेत से परिवार तक।',
    footerBrandNote:'सोच-समझकर प्रस्तुत। ईमानदारी से पेश किया गया।',
    footerExplore:'एक नज़र में', footerHome:'होम', footerProducts:'हमारे उत्पाद', footerStory:'हमारी कहानी',
    ...
    faqEyebrow:'सामान्य सवाल', faqTitle:'अक्सर पूछे गए सवाल।<br><em>सीधे जवाब।</em>', faqIntro:'GLOPE Honey, ऑर्डर, भंडारण और आने वाले उत्पाद से जुड़े उपयोगी जवाब।',
